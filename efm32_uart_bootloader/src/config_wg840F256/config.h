 ...
 *    This configuration file describes the WG840 parts and larger. (Eg. USART1)
 *    is available.
 * @author Silicon Labs
 * @version 1.68
 ******************************************************************************
...
#define BOOTLOADER_USART_A           LEUART1
#define BOOTLOADER_USART_A_TYPE      LEUART
#define BOOTLOADER_USART_A_HFCLOCK     CMU_LFBCLKEN0_LEUART1
...
#define BOOTLOADER_USART_A_PIN_TX 6
#define BOOTLOADER_USART_A_PORT_RX 2
#define BOOTLOADER_USART_A_PIN_RX 7
#define BOOTLOADER_USART_A_TX_MODE GPIO_P_MODEL_MODE6_WIREDANDPULLUP
#define BOOTLOADER_USART_A_RX_MODE GPIO_P_MODEL_MODE7_WIREDANDPULLUP
#define BOOTLOADER_USART_A_MODE MODEL

//USART CLKDIV for 115200
//28MHZ 3634 | 21MHZ 2661 | 14MHZ 1688
#define BOOTLOADER_USART_A_CLKDIV 0x77C0
...
#define BOOTLOADER_USART_B_HFCLOCK     CMU_LFBCLKEN0_LEUART0
#define BOOTLOADER_USART_B_LFCLOCK     0
#define BOOTLOADER_USART_B_LOCATION  USART_ROUTE_LOCATION_LOC2

#define BOOTLOADER_USART_B_PORT_TX 4
#define BOOTLOADER_USART_B_PIN_TX 14
#define BOOTLOADER_USART_B_PORT_RX 4
#define BOOTLOADER_USART_B_PIN_RX 15
#define BOOTLOADER_USART_B_TX_MODE GPIO_P_MODEH_MODE14_WIREDANDPULLUP
#define BOOTLOADER_USART_B_RX_MODE GPIO_P_MODEH_MODE15_WIREDANDPULLUP
