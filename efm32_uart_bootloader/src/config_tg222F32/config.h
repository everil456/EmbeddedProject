...
#define BOOTLOADER_USART_A_LOCATION  USART_ROUTE_LOCATION_LOC1

#define BOOTLOADER_USART_A_PORT_TX 1
#define BOOTLOADER_USART_A_PIN_TX 13
#define BOOTLOADER_USART_A_PORT_RX 1
#define BOOTLOADER_USART_A_PIN_RX 14
#define BOOTLOADER_USART_A_TX_MODE GPIO_P_MODEH_MODE13_WIREDANDPULLUP
#define BOOTLOADER_USART_A_RX_MODE GPIO_P_MODEH_MODE14_WIREDANDPULLUP
#define BOOTLOADER_USART_A_MODE MODEH
