...
#define BOOTLOADER_USART_A           USART0
#define BOOTLOADER_USART_A_TYPE      USART
#define BOOTLOADER_USART_A_HFCLOCK     CMU_HFPERCLKEN0_USART0
#define BOOTLOADER_USART_A_LFCLOCK     0
#define BOOTLOADER_USART_A_LOCATION  USART_ROUTE_LOCATION_LOC2

#define BOOTLOADER_USART_A_PORT_TX 2
#define BOOTLOADER_USART_A_PIN_TX 10
#define BOOTLOADER_USART_A_PORT_RX 2
#define BOOTLOADER_USART_A_PIN_RX 11
#define BOOTLOADER_USART_A_TX_MODE GPIO_P_MODEH_MODE10_WIREDANDPULLUP
#define BOOTLOADER_USART_A_RX_MODE GPIO_P_MODEH_MODE11_WIREDANDPULLUP
